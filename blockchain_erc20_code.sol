...
import "http://github.com/OpenZeppelin/openzeppelin-contracts/contracts/token/ERC20/extensions/IERC20Metadata.sol";
...
contract Main_token is ERC20{
    constructor() ERC20('Metamasker','PC'){
        if(created==0){
